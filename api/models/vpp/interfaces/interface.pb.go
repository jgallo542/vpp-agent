...
type MemifLink struct {
	...
	NoZeroCopy           bool                `protobuf:"varint,10,opt,name=no_zero_copy,json=noZeroCopy,proto3" json:"no_zero_copy,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *MemifLink) GetNoZeroCopy() bool {
	if m != nil {
		return m.NoZeroCopy
	}
	return false
...
var fileDescriptor_1ac7cab935c1dc4d = []byte{
	...
	,
}
